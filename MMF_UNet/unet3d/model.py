...
from MMF_UNet.unet3d.buildingblocksori import DoubleConv, ResNetBlock, ResNetBlockSE, SingleConv,\
    create_decoders, create_encoders
from MMF_UNet.unet3d.utils import get_class, number_of_features_per_level
...
class AbstractUNet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, basic_module, f_maps=64, layer_order='gcr',
                 ...
                 conv_padding=1, conv_upscale=2, upsample='default', dropout_prob=0.1, is3d=True, first_need_down=False, name='UNet3D'):
        ...
        self.encoders = create_encoders(in_channels, f_maps, basic_module, conv_kernel_size,
                                        ...
                                        layer_order, num_groups, pool_kernel_size, is3d, first_need_down=first_need_down)
    ...
    def forward(self, x):
        ...
        # print('len: ', len(encoders_features), len(self.decoders))
...
class RefineNet(AbstractUNet):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid=True, f_maps=64, layer_order='gcr',
        ...
        super(RefineNet, self).__init__(in_channels=in_channels,
                                     ...
                                     conv_padding=conv_padding,
                                     is3d=True,
                                     first_need_down=True, name='RefineNet')
        self.final_conv = nn.ConvTranspose3d(in_channels=f_maps[0], out_channels=out_channels, kernel_size=(3, 7, 7), stride=(1, 3, 3), padding=(1, 1, 1))
        
def get_model(model_config):
    model_class = get_class(model_config['name'], modules=[
        'MMF_UNet.unet3d.model'
    ])
